...
public class POST_assign_a_product_rating {
    public String POST_valid_endpoint_product_rating = "https://altashop-api.fly.dev/api/products/12895/ratings";
    public String POST_invalid_endpoint_product_rating = "https://altashop-api.fly.dev/api/products/12237/rating";
    public String POST_endpoint_empty_product_rating = "https://altashop-api.fly.dev/api/products/12893/ratings";
